defmodule BackWeb.WorkingtimeControllerTest do
  ...
  @update_attrs %{
    end: ~N[2021-11-04 10:02:00],
    start: ~N[2021-11-04 10:02:00]
  }
  ...
  describe "create workingtime" do
    test "renders workingtime when data is valid", %{conn: conn} do
      ...
      assert %{
               "id" => ^id,
               "end" => "2021-11-03T10:02:00",
               "start" => "2021-11-03T10:02:00"
  ...
  describe "update workingtime" do
    ...
    test "renders workingtime when data is valid", %{conn: conn, workingtime: %Workingtime{id: id} = workingtime} do
      ...
      assert %{
               "id" => ^id,
               "end" => "2021-11-04T10:02:00",
               "start" => "2021-11-04T10:02:00"
             } = json_response(conn, 200)["data"]
    end
